      ...
      <div className="bg-white rounded-3xl w-[600px] p-8 shadow-2xl">
        ...
        <div className="mb-4">
          <SelectComp
            ...
            //   onChange={(value) => handleContactMethodChange(value ?? "")}
            required={true}
            options={[
              { value: "sms", label: "dasd" },
              { value: "whatsapp", label: "da" },
              { value: "email", label: "adfad" },
            ]}
          />
        </div>
        ...
        <Group justify="center" className="mt-[50px]">
          <Button action={() => router.push("/otppage")} label="Send Code">
            Send Code
          </Button>
        </Group>
